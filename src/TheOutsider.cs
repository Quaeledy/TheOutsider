...
namespace TheOutsider
{
    public class TheOutsider
    {
            ...
            get
            {
                if (playerRef.TryGetTarget(out Player player))
                    return player.SlugCatClass == Plugin.SlugName ||
                           player.slugcatStats.name == Plugin.Mothpup || player.abstractCreature.creatureTemplate.type == TheOutsiderEnums.CreatureTemplateType.Mothpup || isMothNPC;
                else
                    return false;
            }
        }
        ...
        public TheOutsider(Player player)
        {
            ...
            flyingBuzzSound.sound = TheOutsiderEnums.MothBuzz;
