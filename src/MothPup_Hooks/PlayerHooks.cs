...
namespace TheOutsider.MothPup_Hooks
{
    public class PlayerHooks
    {
        ...
        private static void IL_Player_Jump(ILContext il)
        {
            ...
            aquaCurs.TryGotoNext(MoveType.After, x => x.MatchCall<Player>("get_isSlugpup"));
            /* GOTO AFTER IL_01ad
             * 	IL_01ac: ldarg.0
            ...
            aquaCurs.TryGotoNext(MoveType.After, x => x.MatchLdcR4(2.25f));
            /* GOTO AFTER IL_02a0
            ...
            aquaCurs.TryGotoNext(MoveType.After, x => x.MatchLdcR4(1f));
            /* GOTO AFTER IL_02ca
            ...
            aquaCurs.TryGotoNext(MoveType.After, x => x.MatchLdcR4(0.65f));
            /* GOTO AFTER IL_06fd
             *	IL_06f6: ldc.r4 1
            ...
            aquaCurs.TryGotoNext(MoveType.After, x => x.MatchLdcR4(6f));
            /* GOTO AFTER IL_0816
            ...
            aquaCurs.TryGotoNext(x => x.MatchCall<Player>("get_isSlugpup"));
            aquaCurs.TryGotoNext(MoveType.After, x => x.MatchLdcR4(3f));
            /* GOTO AFTER IL_140e
	         *	IL_140d: ldarg.0
	         *  IL_140e: ldc.r4 3
            ...
            aquaCurs.TryGotoNext(MoveType.After, x => x.MatchLdcR4(5.5f));
            /* GOTO AFTER IL_15bf
        ...
        private static void IL_Player_UpdateAnimation(ILContext il)
        {
            ...
            swimCurs.TryGotoNext(x => x.MatchLdsfld<Player.AnimationIndex>(nameof(Player.AnimationIndex.DeepSwim)));
            swimCurs.TryGotoNext(MoveType.After, x => x.MatchCall<Player>("get_isRivulet"));
            /* GOTO AFTER IL_24f4
             * 	IL_24f3: ldarg.0
            ...
            swimCurs.TryGotoNext(x => x.Match(OpCodes.Br));
            swimCurs.TryGotoNext(MoveType.After, x => x.MatchBr(out burstLabel), x => x.MatchLdarg(0)); // Get out IL_2683 as burstLabel
            /* GOTO AFTER IL_263c
            ...
            swimCurs.TryGotoNext(MoveType.After, x => x.MatchStfld<Player>(nameof(Player.waterJumpDelay)));
            /* GOTO AFTER IL_26d4
            ...
            swimCurs.TryGotoNext(MoveType.After, x => x.MatchLdcR4(18f));
            /* GOTO AFTER IL_3134
            ...
            swimCurs.TryGotoNext(MoveType.After, x => x.MatchLdcI4(6));
            /* GOTO AFTER IL_3213
            ...
            swimCurs.TryGotoNext(MoveType.After, x => x.MatchLdcR4(12f));
            /* GOTO AFTER IL_315e
        ...
        private static void IL_Player_LungUpdate(ILContext il)
        {
            ...
            aquaCurs.TryGotoNext(MoveType.After, x => x.MatchCall<Player>("get_isRivulet"));
            /* GOTO AFTER IL_0465
	         *  IL_0464: ldarg.0
        ...
        private static void IL_Player_ctor(ILContext il)
        {
            ...
            pupCurs.TryGotoNext(MoveType.After, x => x.MatchCall<Player>(nameof(Player.SetMalnourished)));
            /* GOTO AFTER IL_0a7f
        ...
        private static void IL_Player_Update(ILContext il)
        {
            ...
            exhaustCurs.TryGotoNext(MoveType.After, x => x.MatchLdfld<Player>(nameof(Player.gourmandExhausted)));
        ...
        private static void IL_Player_SwallowObject(ILContext il)
        {
            ...
            parentCurs.TryGotoNext(MoveType.After, x => x.MatchStloc(0));
            /* GOTO AFTER IL_0021
	            IL_0016: ldelem.ref
            ...
            */
            ...
            graspedCurs.TryGotoNext(MoveType.After, x => x.MatchCallvirt<Creature>(nameof(Creature.ReleaseGrasp)));
            /* GOTO AFTER IL_007d
                IL_007b: ldarg.0
                IL_007c: ldarg.1
            ...
            */
            ...
            parentCurs.TryGotoNext(MoveType.After, x => x.MatchCallvirt<StoryGameSession>(nameof(StoryGameSession.RemovePersistentTracker)), x => x.MatchLdarg(0));
            /* GOTO AFTER IL_007b
        ...
        private static void IL_Player_GrabUpdate(ILContext il)
        {
            ...
            counterCurs.TryGotoNext(x => x.MatchStfld<PlayerGraphics>(nameof(PlayerGraphics.swallowing)));
            counterCurs.TryGotoNext(x => x.MatchLdcI4(0), x => x.MatchStfld<Player>(nameof(Player.swallowAndRegurgitateCounter)));
	         ...
	         *  IL_1ae5: ldc.i4.0
             */
            counterCurs.TryGotoNext(MoveType.After, x => x.MatchLdarg(0));
            /* GOTO AFTER IL_1ae4
             * 	IL_1ae4: ldarg.0
	         *  IL_1ae5: ldc.i4.0
        ...
        private static void IL_Player_StomachGlowLightColor(ILContext il)
        {
            ...
            glowCurs.TryGotoNext(MoveType.After, x => x.Match(OpCodes.Call));
            /* GOTO AFTER IL_0001
             * 	IL_0000: ldarg.0
