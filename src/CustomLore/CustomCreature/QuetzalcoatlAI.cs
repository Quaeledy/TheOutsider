...
namespace TheOutsider.CustomLore.CustomCreature
{
    sealed class QuetzalcoatlAI : ArtificialIntelligence, IUseARelationshipTracker
    {
        ...
        sealed class QuetzalcoatlTrackedState : RelationshipTracker.TrackedCreatureState
        {
        ...
        public QuetzalcoatlAI(AbstractCreature acrit, Quetzalcoatl bug) : base(acrit, acrit.world)
        {
            this.bug = bug;
            bug.AI = this;
        ...
        public override void CreatureSpotted(bool firstSpot, Tracker.CreatureRepresentation otherCreature)
        {
            ...
            // 如果我们漫无目的地闲逛，找到了另一个团队成员，停止我们正在做的事情，和他们在一起
        ...
        {
            return new QuetzalcoatlTrackedState();
        }
        ...
        {
            if (dRelation.state is not QuetzalcoatlTrackedState state) return default;
