...
namespace TheOutsider.PlayerGraphics_Hooks
{
    ...
    {
        public static FAtlas antennaeAtlas;
        ...
        private static void PlayerGraphics_InitiateSprites(On.PlayerGraphics.orig_InitiateSprites orig, PlayerGraphics self, RoomCamera.SpriteLeaser sLeaser, RoomCamera rCam)
        {
            ...
            //触须
            antennaeAtlas = Futile.atlasManager.LoadAtlas("atlases/mothantennae1");
            antennaeAtlas = Futile.atlasManager.LoadAtlas("atlases/mothantennae2");
        ...
        private static void PlayerGraphics_DrawSprites(On.PlayerGraphics.orig_DrawSprites orig, PlayerGraphics self, RoomCamera.SpriteLeaser sLeaser, RoomCamera rCam, float timeStacker, Vector2 camPos)
        {
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                sLeaser.sprites[player.antennaeSprite + i].color = (Color)Plugin.AntennaeColor.GetColor(self);
